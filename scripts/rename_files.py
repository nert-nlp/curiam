...
for filename in os.listdir("data/main/raw/inception_files"):
    if filename.endswith(".txt"):
        ...
        new_folder = "data/main/processed/inception_files_with_docket_numbers"
        ...
        # See comment below.
        # shutil.copyfile(f"data/main/raw/inception_files/{filename}",
